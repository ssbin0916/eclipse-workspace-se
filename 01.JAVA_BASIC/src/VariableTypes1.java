...
public class VariableTypes1 {
	...
	public static void main(String[] args) {
		 ...
		 * 숫자형
		 * 
		 * 1.정수형변수타입(byte,short,int,long) int kor; int eng; int math; - 정수형변수:
		 * kor,eng,math - 정수형리터럴: 10,23,-90,2343242(int)
		 */
		...
		long l2 = 2147783648l;
		/*
		 * The literal 2147783648 of type int is out of range
		 */
		System.out.println(l1);
		System.out.println(l2);

		/*
		 * 2.실수형변수타입(float,double) float avg; double height; - 실수형변수: avg,height -
		...
		/*
		 * 문자형(한개문자)- 2byte char c1,c2,c3; - 문자형변수(c1,c2,c3) - 문자형리터럴:
		 * 'A','힣','a','1','★'
		 */
		char c1;
		c1 = 'A';
		...
		/*
		 * 논리형 1.논리형변수타입(boolean) boolean b1; boolean b2; - 논리형변수 : b1,b2 - 논리형리터럴 :
		 * true,false
		 */
		boolean bool1 = true;
		boolean bool2 = false;
