...
public class ForTest {
	...
	public static void main(String[] args) {
		 ...
		 * break문
		 *   1. 반복문에서 사용
		 *   2. break문 이후의 반복 코드를 실행하지 않는다
		 *   3. 다음횟수의 반복블록도 실행하지 않는다
		 */

		System.out.println(">>3과 4의 최소공배수만 출력[1~100]");
		for (int i = 1; i <= 100; i++) {
		 ...
		 * continue문
		 *   1. 반복문에서 사용
		 *   2. continue문 이후의 반복 코드를 실행하지 않는다
		 *   3. 다음횟수의 반복블록을 실행한다   
		 */
		System.out.println(">>4의배수가 아닌 수만 출력[1~100](continue)");
		for (int i = 0; i <= 100; i++) {
			if (i % 4 == 0) {
				/*
